package spring.io.state.managment;
...
import static spring.io.state.managment.model.Status.SERVER_DOWN;
import static spring.io.state.managment.model.Status.SERVER_UP;

@SpringBootApplication
public class StateManagmentApplication {

	public static void main(String[] args) {
		SpringApplication.run(StateManagmentApplication.class, args);
	}
